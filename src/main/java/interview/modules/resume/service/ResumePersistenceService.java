...
public class ResumePersistenceService {
    ...
    public Optional<ResumeEntity> findExistingResume(MultipartFile file) {
        try {
            ...
            String fileHash = calculateScopedFileHash(userId, file);
    ...
    public ResumeEntity saveResume(MultipartFile file, String resumeText,
        ...
        try {
            ...
            log.info("简历已保存: userId={}, id={}, hash={}", userId, saved.getId(), fileHash);
    ...
    public void deleteResume(Long id) {
        ...
        log.info("简历已删除: userId={}, id={}, filename={}", userId, id, resume.getOriginalFilename());
    }

    private String calculateScopedFileHash(Long userId, MultipartFile file) {
        String contentHash = fileHashService.calculateHash(file);
        String scopedHashInput = userId + ":" + contentHash;
        return fileHashService.calculateHash(scopedHashInput.getBytes(StandardCharsets.UTF_8));
    }
}
