...
public class KnowledgeBasePersistenceService {
    ...
    public Map<String, Object> handleDuplicateKnowledgeBase(KnowledgeBaseEntity kb) {
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    public void updateVectorStatusToPending(Long userId, Long kbId) {
        ...
        log.info("知识库向量化状态已更新为 PENDING: userId={}, kbId={}", userId, kbId);
    }
