...
/**
 * Bean definitions for {@link ResumeRepository}.
 */
@Generated
public class ResumeRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'resumeRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getResumeRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'resumeRepository'.
   */
  public static BeanDefinition getResumeRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, ResumeRepository.class, ResumeEntity.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "interview.modules.resume.repository.ResumeRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.ResumeRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new interview.modules.resume.repository.ResumeRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getResumeRepositoryInstanceSupplier();
